...
example-code: |
  ...
  var smallMultiples = fc.chart.smallMultiples(subScale, salesScale)
      .key(function(d) {
          return ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'][d.key];
      })
      .columns(7)
