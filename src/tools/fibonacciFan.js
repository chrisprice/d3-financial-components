...
export default function() {
    ...
    var fan = function(selection) {
        ...
        selection.each(function(data) {
            ...
            var g = simpleDataJoin(container, 'fan', data);
    ...
    fan.xScale = property(d3.time.scale());
    fan.yScale = property(d3.scale.linear());
    fan.snap = property(function(x, y) { return {x: x, y: y}; });
    fan.decorate = property(fn.noop);
