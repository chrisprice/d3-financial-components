var pointSnap = function(xScale, yScale, xValue, yValue, data) {
...
pointSnap.series = function(series, data) {
    return function(xPixel, yPixel) {
        ...
        return pointSnap(xScale, yScale, xValue, yValue, data)(xPixel, yPixel);
    };
};

module.exports = pointSnap;